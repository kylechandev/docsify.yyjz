...
| -------------- | ------------ | ---------------------------------------------------------- |:---------------:|:----------------------------:|
| **微信账单**       | `2024/04/20` | `收入` `支出`[获取微信账单](doc/data-manage/get-wx-bill.md)          | Android/iOS     | -                            |
| **支付宝账单(电脑端)** | `2021/05/10` | `收入` `支出`[获取支付宝账单](doc/data-manage/get-ali-bill.md#ali-pc) | Android/iOS     | -                            |
| **支付宝账单(手机端)** | `2023/02/17` | `收入` `支出`[获取支付宝账单](doc/data-manage/get-ali-bill.md)        | Android/iOS     | -                            |
| **鲨鱼记账**       | `2020/06/28` | `收入` `支出`                                                  | Android/iOS     | -                            |
| **微记账**        | `2021/05/10` | `收入` `支出`                                                  | Android/iOS     | -                            |
| **有鱼记账**       | `2020/06/28` | `收入` `支出`                                                  | Android/iOS     | -                            |
| **一羽记账**       | `2024/04/20` | `收入` `支出` `转账`                                             | Android/iOS     | -                            |
...
| **叨叨记账**       | `2024/04/20` | `收入` `支出`                                                  | Android/iOS     | [手动转 .csv 格式](#transfer-csv) |
| **钱迹**         | `2024/04/20` | `收入` `支出` `转账`                                             | Android/iOS     | -                            |
| **Timi记账**     | `2021/05/16` | `收入` `支出`                                                  | Android/iOS     | -                            |
| **图图记账**       | `2023/10/22` | `收入` `支出` `转账`                                             | iOS v3.0.5↑     | -                            |
| **薄荷记账**       | `2024/04/20` | `收入` `支出` `转账`                                             | Android v6.3.2↑ | -                            |
| **一木记账**       | `2024/04/20` | `收入` `支出` `转账`                                             | Android v6.3.2↑ | [手动转 .csv 格式](#transfer-csv) |
| **小星记账**       | `2024/04/20` | `收入` `支出` `转账`                                             | Android v6.3.2↑ | [手动转 .csv 格式](#transfer-csv) |
| **木木记账**       | `2024/04/20` | `收入` `支出` `转账`                                             | Android v6.3.2↑ | [手动转 .csv 格式](#transfer-csv) |
| **小青账**        | `2024/04/20` | `收入` `支出` `转账`                                             | Android v6.9.6↑ | -                            |
