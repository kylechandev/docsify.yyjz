...
| **账单图片** | 账单图片（从[Android v5.6.3](https://www.coolapk.com/apk/kylec.me.lightbookkeeping)版本后支持），填写图片链接，最多支持三个，多个链接直接以英文逗号分隔，<br>例如：`https://example.png,https://example.png,https://example.png` |
